...
// Source: github.com/czh0526/aries-framework-go/pkg/didcomm/dispatcher (interfaces: Outbound)
//
...
func (m *MockOutbound) Forward(arg0 any, arg1 *service.Destination) error {
	m.ctrl.T.Helper()
...
func (mr *MockOutboundMockRecorder) Forward(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Forward", reflect.TypeOf((*MockOutbound)(nil).Forward), arg0, arg1)
}

// Send mocks base method.
func (m *MockOutbound) Send(arg0 any, arg1 string, arg2 *service.Destination) error {
	m.ctrl.T.Helper()
...
func (mr *MockOutboundMockRecorder) Send(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockOutbound) SendToDID(msg any, myDID, theirDID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendToDID", msg, myDID, theirDID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendToDID indicates an expected call of SendToDID.
func (mr *MockOutboundMockRecorder) SendToDID(msg, myDID, theirDID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendToDID", reflect.TypeOf((*MockOutbound)(nil).SendToDID), msg, myDID, theirDID)
}
