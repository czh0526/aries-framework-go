...
func (s *SDJWTBuilderV2) CreateDisclosuresAndDigests(
	path string, claims map[string]interface{}, opts *newOpts) ([]*DisclosureEntity, map[string]interface{}, error) {
	var (
		disclosures      []*DisclosureEntity
		levelDisclosures []*DisclosureEntity
	)
...
func (b *SDJWTBuilderV2) SetDefaultSaltSize(size int) *SDJWTBuilderV2 {
	b.defaultSaltSize = size
	return b
}
